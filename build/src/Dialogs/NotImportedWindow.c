...
static void _lambda20_ (GtkCellRendererToggle* toggle, const gchar* path, BeatBoxNotImportedWindow* self);
...
static void __lambda20__gtk_cell_renderer_toggle_toggled (GtkCellRendererToggle* _sender, const gchar* path, gpointer self);
...
static void _lambda21_ (BeatBoxNotImportedWindow* self);
static void __lambda21__gtk_button_clicked (GtkButton* _sender, gpointer self);
static void _lambda22_ (Block1Data* _data1_);
static void __lambda22__gtk_expander_activate (GtkExpander* _sender, gpointer self);
...
BeatBoxNotImportedWindow* beat_box_not_imported_window_construct (GType object_type, BeatBoxLibraryWindow* lw, GeeLinkedList* files) {
	...
	g_signal_connect_object (toggle, "toggled", (GCallback) __lambda20__gtk_cell_renderer_toggle_toggled, self, 0);
	...
	g_signal_connect_object (okButton, "clicked", (GCallback) __lambda21__gtk_button_clicked, self, 0);
	g_signal_connect_data (_data1_->exp, "activate", (GCallback) __lambda22__gtk_expander_activate, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
