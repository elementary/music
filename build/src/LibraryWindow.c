...
void beat_box_library_window_build_ui (BeatBoxLibraryWindow* self) {
	...
	_tmp14_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Library");
	...
	_tmp21_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("About");
	_g_object_unref0 (self->priv->helpAbout);
	self->priv->helpAbout = g_object_ref_sink (_tmp21_);
	_tmp22_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Preferences");
...
static void beat_box_library_window_real_musicAdded (BeatBoxLibraryWindow* self, GeeLinkedList* not_imported) {
	...
	if (_tmp26_ > 0) {
		...
		_tmp27_ = beat_box_not_imported_window_new (not_imported);
