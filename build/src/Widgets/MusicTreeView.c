...
void beat_box_music_tree_view_buildUI (BeatBoxMusicTreeView* self) {
	...
	gint _tmp117_;
	gint _tmp118_;
	GtkTreeSelection* _tmp119_ = NULL;
	GtkTargetEntry* _tmp120_ = NULL;
	GtkTargetEntry* _tmp121_;
	gint _tmp121__length1;
	GtkMenu* _tmp122_ = NULL;
	GtkMenu* _tmp123_;
	GtkMenuItem* _tmp124_ = NULL;
	GtkMenuItem* _tmp125_;
	GtkCheckMenuItem* _tmp126_ = NULL;
	GtkCheckMenuItem* _tmp127_;
	GtkCheckMenuItem* _tmp128_ = NULL;
	GtkCheckMenuItem* _tmp129_;
	GtkCheckMenuItem* _tmp130_ = NULL;
	GtkCheckMenuItem* _tmp131_;
	GtkCheckMenuItem* _tmp132_ = NULL;
	GtkCheckMenuItem* _tmp133_;
	GtkCheckMenuItem* _tmp134_ = NULL;
	GtkCheckMenuItem* _tmp135_;
	...
	GtkCheckMenuItem* _tmp142_ = NULL;
	GtkCheckMenuItem* _tmp143_;
	...
	GtkCheckMenuItem* _tmp152_ = NULL;
	GtkCheckMenuItem* _tmp153_;
	GtkCheckMenuItem* _tmp154_ = NULL;
	GtkCheckMenuItem* _tmp155_;
	GtkSeparatorMenuItem* _tmp156_ = NULL;
	GtkSeparatorMenuItem* _tmp157_;
	GtkMenu* _tmp158_ = NULL;
	GtkMenu* _tmp159_;
	GtkMenuItem* _tmp160_ = NULL;
	GtkMenuItem* _tmp161_;
	GtkMenuItem* _tmp162_ = NULL;
	GtkMenuItem* _tmp163_;
	GtkMenuItem* _tmp164_ = NULL;
	GtkMenuItem* _tmp165_;
	...
	gtk_tree_sortable_set_sort_column_id ((GtkTreeSortable*) self->priv->sort, _tmp117_, self->priv->sort_direction);
	...
	_tmp118_ = gee_abstract_list_index_of ((GeeAbstractList*) self->priv->_columns, "Artist");
	gtk_tree_sortable_set_sort_func ((GtkTreeSortable*) self->priv->sort, _tmp118_, _beat_box_music_tree_view_artistCompareFunc_gtk_tree_iter_compare_func, g_object_ref (self), g_object_unref);
	_tmp119_ = gtk_tree_view_get_selection (self->priv->view);
	gtk_tree_selection_set_mode (_tmp119_, GTK_SELECTION_MULTIPLE);
	_tmp120_ = g_new0 (GtkTargetEntry, 0);
	_tmp121_ = _tmp120_;
	_tmp121__length1 = 0;
	gtk_drag_source_set ((GtkWidget*) self->priv->view, GDK_BUTTON1_MASK, _tmp121_, 0, GDK_ACTION_MOVE);
	_tmp121_ = (g_free (_tmp121_), NULL);
	gtk_drag_source_add_uri_targets ((GtkWidget*) self->priv->view);
	_tmp122_ = (GtkMenu*) gtk_menu_new ();
	_tmp123_ = g_object_ref_sink (_tmp122_);
	_g_object_unref0 (self->priv->columnChooserMenu);
	self->priv->columnChooserMenu = _tmp123_;
	_tmp124_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Smart sorting");
	_tmp125_ = g_object_ref_sink (_tmp124_);
	_g_object_unref0 (self->priv->columnSmartSorting);
	self->priv->columnSmartSorting = _tmp125_;
	_tmp126_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("#");
	_tmp127_ = g_object_ref_sink (_tmp126_);
	_g_object_unref0 (self->priv->columnNumber);
	self->priv->columnNumber = _tmp127_;
	_tmp128_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Track");
	_tmp129_ = g_object_ref_sink (_tmp128_);
	_g_object_unref0 (self->priv->columnTrack);
	self->priv->columnTrack = _tmp129_;
	_tmp130_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Title");
	_tmp131_ = g_object_ref_sink (_tmp130_);
	_g_object_unref0 (self->priv->columnTitle);
	self->priv->columnTitle = _tmp131_;
	_tmp132_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Length");
	_tmp133_ = g_object_ref_sink (_tmp132_);
	_g_object_unref0 (self->priv->columnLength);
	self->priv->columnLength = _tmp133_;
	_tmp134_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Artist");
	_tmp135_ = g_object_ref_sink (_tmp134_);
	_g_object_unref0 (self->priv->columnArtist);
	self->priv->columnArtist = _tmp135_;
	_tmp136_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Album");
	_tmp137_ = g_object_ref_sink (_tmp136_);
	_g_object_unref0 (self->priv->columnAlbum);
	self->priv->columnAlbum = _tmp137_;
	_tmp138_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Genre");
	_tmp139_ = g_object_ref_sink (_tmp138_);
	_g_object_unref0 (self->priv->columnGenre);
	self->priv->columnGenre = _tmp139_;
	_tmp140_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Year");
	_tmp141_ = g_object_ref_sink (_tmp140_);
	_g_object_unref0 (self->priv->columnYear);
	self->priv->columnYear = _tmp141_;
	_tmp142_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Bitrate");
	_tmp143_ = g_object_ref_sink (_tmp142_);
	_g_object_unref0 (self->priv->columnBitRate);
	self->priv->columnBitRate = _tmp143_;
	_tmp144_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Rating");
	_tmp145_ = g_object_ref_sink (_tmp144_);
	_g_object_unref0 (self->priv->columnRating);
	self->priv->columnRating = _tmp145_;
	_tmp146_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Plays");
	_tmp147_ = g_object_ref_sink (_tmp146_);
	_g_object_unref0 (self->priv->columnPlayCount);
	self->priv->columnPlayCount = _tmp147_;
	_tmp148_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Skips");
	_tmp149_ = g_object_ref_sink (_tmp148_);
	_g_object_unref0 (self->priv->columnSkipCount);
	self->priv->columnSkipCount = _tmp149_;
	_tmp150_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Date Added");
	_tmp151_ = g_object_ref_sink (_tmp150_);
	_g_object_unref0 (self->priv->columnDateAdded);
	self->priv->columnDateAdded = _tmp151_;
	_tmp152_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Last Played");
	_tmp153_ = g_object_ref_sink (_tmp152_);
	_g_object_unref0 (self->priv->columnLastPlayed);
	self->priv->columnLastPlayed = _tmp153_;
	_tmp154_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("BPM");
	_tmp155_ = g_object_ref_sink (_tmp154_);
	_g_object_unref0 (self->priv->columnBPM);
	self->priv->columnBPM = _tmp155_;
	...
	_tmp156_ = (GtkSeparatorMenuItem*) gtk_separator_menu_item_new ();
	_tmp157_ = g_object_ref_sink (_tmp156_);
	gtk_menu_shell_append ((GtkMenuShell*) self->priv->columnChooserMenu, (GtkWidget*) ((GtkMenuItem*) _tmp157_));
	...
	_tmp158_ = (GtkMenu*) gtk_menu_new ();
	_tmp159_ = g_object_ref_sink (_tmp158_);
	_g_object_unref0 (self->priv->songMenuActionMenu);
	self->priv->songMenuActionMenu = _tmp159_;
	_tmp160_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Edit Song Info");
	_tmp161_ = g_object_ref_sink (_tmp160_);
	_g_object_unref0 (self->priv->songEditSong);
	self->priv->songEditSong = _tmp161_;
	_tmp162_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Show in File Browser");
	_tmp163_ = g_object_ref_sink (_tmp162_);
	_g_object_unref0 (self->priv->songFileBrowse);
	self->priv->songFileBrowse = _tmp163_;
	_tmp164_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Queue");
	_tmp165_ = g_object_ref_sink (_tmp164_);
	_g_object_unref0 (self->priv->songMenuQueue);
	self->priv->songMenuQueue = _tmp165_;
	_tmp166_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("New Playlist");
	_tmp167_ = g_object_ref_sink (_tmp166_);
	_g_object_unref0 (self->priv->songMenuNewPlaylist);
	self->priv->songMenuNewPlaylist = _tmp167_;
	_tmp168_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Add to Playlist");
	_tmp169_ = g_object_ref_sink (_tmp168_);
	_g_object_unref0 (self->priv->songMenuAddToPlaylist);
	self->priv->songMenuAddToPlaylist = _tmp169_;
	_tmp170_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Remove song");
	_tmp171_ = g_object_ref_sink (_tmp170_);
	_g_object_unref0 (self->priv->songRemove);
	self->priv->songRemove = _tmp171_;
	_tmp172_ = (GtkMenu*) gtk_menu_new ();
	_tmp173_ = g_object_ref_sink (_tmp172_);
	_g_object_unref0 (self->priv->songRateSongMenu);
	self->priv->songRateSongMenu = _tmp173_;
	_tmp174_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Rate Song");
	_tmp175_ = g_object_ref_sink (_tmp174_);
	_g_object_unref0 (self->priv->songRateSong);
	self->priv->songRateSong = _tmp175_;
	_tmp176_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("No Stars");
	_tmp177_ = g_object_ref_sink (_tmp176_);
	_g_object_unref0 (self->priv->songRateSong0);
	self->priv->songRateSong0 = _tmp177_;
	_tmp178_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("1 Stars");
	_tmp179_ = g_object_ref_sink (_tmp178_);
	_g_object_unref0 (self->priv->songRateSong1);
	self->priv->songRateSong1 = _tmp179_;
	_tmp180_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("2 Stars");
	_tmp181_ = g_object_ref_sink (_tmp180_);
	_g_object_unref0 (self->priv->songRateSong2);
	self->priv->songRateSong2 = _tmp181_;
	_tmp182_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("3 Stars");
	_tmp183_ = g_object_ref_sink (_tmp182_);
	_g_object_unref0 (self->priv->songRateSong3);
	self->priv->songRateSong3 = _tmp183_;
	_tmp184_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("4 Stars");
	_tmp185_ = g_object_ref_sink (_tmp184_);
	_g_object_unref0 (self->priv->songRateSong4);
	self->priv->songRateSong4 = _tmp185_;
	_tmp186_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("5 Stars");
	_tmp187_ = g_object_ref_sink (_tmp186_);
	_g_object_unref0 (self->priv->songRateSong5);
	self->priv->songRateSong5 = _tmp187_;
	...
	_tmp188_ = (GtkSeparatorMenuItem*) gtk_separator_menu_item_new ();
	_tmp189_ = g_object_ref_sink (_tmp188_);
	gtk_menu_shell_append ((GtkMenuShell*) self->priv->songMenuActionMenu, (GtkWidget*) ((GtkMenuItem*) _tmp189_));
	...
	_tmp190_ = (GtkSeparatorMenuItem*) gtk_separator_menu_item_new ();
	_tmp191_ = g_object_ref_sink (_tmp190_);
	gtk_menu_shell_append ((GtkMenuShell*) self->priv->songMenuActionMenu, (GtkWidget*) ((GtkMenuItem*) _tmp191_));
	...
	_tmp192_ = gtk_scrolled_window_get_vadjustment ((GtkScrolledWindow*) self);
	g_signal_connect_object (_tmp192_, "value-changed", (GCallback) _beat_box_music_tree_view_viewScroll_gtk_adjustment_value_changed, self, 0);
...
void beat_box_music_tree_view_setAsCurrentList (BeatBoxMusicTreeView* self, const gchar* current_song_path) {
	...
	if (_tmp19_) {
		beat_box_library_manager_shuffleMusic (self->priv->lm, self->priv->lm->shuffle);
	}
}
