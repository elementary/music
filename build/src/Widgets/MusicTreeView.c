...
void beat_box_music_tree_view_buildUI (BeatBoxMusicTreeView* self) {
	...
	gint _tmp107_;
	gint _tmp108_;
	GtkTreeSelection* _tmp109_ = NULL;
	GtkTargetEntry* _tmp110_ = NULL;
	GtkTargetEntry* _tmp111_;
	...
	GtkCheckMenuItem* _tmp128_ = NULL;
	GtkSeparatorMenuItem* _tmp129_ = NULL;
	GtkSeparatorMenuItem* _tmp130_;
	GtkMenu* _tmp131_ = NULL;
	...
	GtkMenuItem* _tmp145_ = NULL;
	GtkSeparatorMenuItem* _tmp146_ = NULL;
	GtkSeparatorMenuItem* _tmp147_;
	GtkSeparatorMenuItem* _tmp148_ = NULL;
	GtkSeparatorMenuItem* _tmp149_;
	...
	_tmp111_ = _tmp110_;
	_tmp111__length1 = 0;
	gtk_drag_source_set ((GtkWidget*) self->priv->view, GDK_BUTTON1_MASK, _tmp111_, 0, GDK_ACTION_MOVE);
	_tmp111_ = (g_free (_tmp111_), NULL);
	gtk_drag_source_add_uri_targets ((GtkWidget*) self->priv->view);
	_tmp112_ = (GtkMenu*) gtk_menu_new ();
	_g_object_unref0 (self->priv->columnChooserMenu);
	self->priv->columnChooserMenu = g_object_ref_sink (_tmp112_);
	_tmp113_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Smart sorting");
	_g_object_unref0 (self->priv->columnSmartSorting);
	self->priv->columnSmartSorting = g_object_ref_sink (_tmp113_);
	_tmp114_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("#");
	_g_object_unref0 (self->priv->columnNumber);
	self->priv->columnNumber = g_object_ref_sink (_tmp114_);
	_tmp115_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Track");
	_g_object_unref0 (self->priv->columnTrack);
	self->priv->columnTrack = g_object_ref_sink (_tmp115_);
	_tmp116_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Title");
	_g_object_unref0 (self->priv->columnTitle);
	self->priv->columnTitle = g_object_ref_sink (_tmp116_);
	_tmp117_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Length");
	_g_object_unref0 (self->priv->columnLength);
	self->priv->columnLength = g_object_ref_sink (_tmp117_);
	_tmp118_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Artist");
	_g_object_unref0 (self->priv->columnArtist);
	self->priv->columnArtist = g_object_ref_sink (_tmp118_);
	_tmp119_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Album");
	_g_object_unref0 (self->priv->columnAlbum);
	self->priv->columnAlbum = g_object_ref_sink (_tmp119_);
	_tmp120_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Genre");
	_g_object_unref0 (self->priv->columnGenre);
	self->priv->columnGenre = g_object_ref_sink (_tmp120_);
	_tmp121_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Year");
	_g_object_unref0 (self->priv->columnYear);
	self->priv->columnYear = g_object_ref_sink (_tmp121_);
	_tmp122_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Bitrate");
	_g_object_unref0 (self->priv->columnBitRate);
	self->priv->columnBitRate = g_object_ref_sink (_tmp122_);
	_tmp123_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Rating");
	_g_object_unref0 (self->priv->columnRating);
	self->priv->columnRating = g_object_ref_sink (_tmp123_);
	_tmp124_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Plays");
	_g_object_unref0 (self->priv->columnPlayCount);
	self->priv->columnPlayCount = g_object_ref_sink (_tmp124_);
	_tmp125_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Skips");
	_g_object_unref0 (self->priv->columnSkipCount);
	self->priv->columnSkipCount = g_object_ref_sink (_tmp125_);
	_tmp126_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Date Added");
	_g_object_unref0 (self->priv->columnDateAdded);
	self->priv->columnDateAdded = g_object_ref_sink (_tmp126_);
	_tmp127_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("Last Played");
	_g_object_unref0 (self->priv->columnLastPlayed);
	self->priv->columnLastPlayed = g_object_ref_sink (_tmp127_);
	_tmp128_ = (GtkCheckMenuItem*) gtk_check_menu_item_new_with_label ("BPM");
	_g_object_unref0 (self->priv->columnBPM);
	self->priv->columnBPM = g_object_ref_sink (_tmp128_);
	...
	gtk_menu_shell_append ((GtkMenuShell*) self->priv->columnChooserMenu, (GtkWidget*) ((GtkMenuItem*) _tmp130_));
	...
	_tmp131_ = (GtkMenu*) gtk_menu_new ();
	_g_object_unref0 (self->priv->songMenuActionMenu);
	self->priv->songMenuActionMenu = g_object_ref_sink (_tmp131_);
	_tmp132_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Edit Song Info");
	_g_object_unref0 (self->priv->songEditSong);
	self->priv->songEditSong = g_object_ref_sink (_tmp132_);
	_tmp133_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Show in File Browser");
	_g_object_unref0 (self->priv->songFileBrowse);
	self->priv->songFileBrowse = g_object_ref_sink (_tmp133_);
	_tmp134_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Queue");
	_g_object_unref0 (self->priv->songMenuQueue);
	self->priv->songMenuQueue = g_object_ref_sink (_tmp134_);
	_tmp135_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("New Playlist");
	_g_object_unref0 (self->priv->songMenuNewPlaylist);
	self->priv->songMenuNewPlaylist = g_object_ref_sink (_tmp135_);
	_tmp136_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Add to Playlist");
	_g_object_unref0 (self->priv->songMenuAddToPlaylist);
	self->priv->songMenuAddToPlaylist = g_object_ref_sink (_tmp136_);
	_tmp137_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Remove song");
	_g_object_unref0 (self->priv->songRemove);
	self->priv->songRemove = g_object_ref_sink (_tmp137_);
	_tmp138_ = (GtkMenu*) gtk_menu_new ();
	_g_object_unref0 (self->priv->songRateSongMenu);
	self->priv->songRateSongMenu = g_object_ref_sink (_tmp138_);
	_tmp139_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("Rate Song");
	_g_object_unref0 (self->priv->songRateSong);
	self->priv->songRateSong = g_object_ref_sink (_tmp139_);
	_tmp140_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("No Stars");
	_g_object_unref0 (self->priv->songRateSong0);
	self->priv->songRateSong0 = g_object_ref_sink (_tmp140_);
	_tmp141_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("1 Stars");
	_g_object_unref0 (self->priv->songRateSong1);
	self->priv->songRateSong1 = g_object_ref_sink (_tmp141_);
	_tmp142_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("2 Stars");
	_g_object_unref0 (self->priv->songRateSong2);
	self->priv->songRateSong2 = g_object_ref_sink (_tmp142_);
	_tmp143_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("3 Stars");
	_g_object_unref0 (self->priv->songRateSong3);
	self->priv->songRateSong3 = g_object_ref_sink (_tmp143_);
	_tmp144_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("4 Stars");
	_g_object_unref0 (self->priv->songRateSong4);
	self->priv->songRateSong4 = g_object_ref_sink (_tmp144_);
	_tmp145_ = (GtkMenuItem*) gtk_menu_item_new_with_label ("5 Stars");
	_g_object_unref0 (self->priv->songRateSong5);
	self->priv->songRateSong5 = g_object_ref_sink (_tmp145_);
	...
	_tmp146_ = (GtkSeparatorMenuItem*) gtk_separator_menu_item_new ();
	_tmp147_ = g_object_ref_sink (_tmp146_);
	gtk_menu_shell_append ((GtkMenuShell*) self->priv->songMenuActionMenu, (GtkWidget*) ((GtkMenuItem*) _tmp147_));
	...
	_tmp148_ = (GtkSeparatorMenuItem*) gtk_separator_menu_item_new ();
	_tmp149_ = g_object_ref_sink (_tmp148_);
	gtk_menu_shell_append ((GtkMenuShell*) self->priv->songMenuActionMenu, (GtkWidget*) ((GtkMenuItem*) _tmp149_));
	...
	_tmp150_ = gtk_scrolled_window_get_vadjustment ((GtkScrolledWindow*) self);
	g_signal_connect_object (_tmp150_, "value-changed", (GCallback) _beat_box_music_tree_view_viewScroll_gtk_adjustment_value_changed, self, 0);
