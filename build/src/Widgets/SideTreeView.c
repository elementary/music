...
void beat_box_side_tree_view_buildUI (BeatBoxSideTreeView* self) {
	...
	_tmp26_ = g_new0 (GtkTargetEntry, 0);
	_tmp27_ = _tmp26_;
	_tmp27__length1 = 0;
	gtk_drag_dest_set ((GtkWidget*) self, GTK_DEST_DEFAULT_ALL, _tmp27_, 0, GDK_ACTION_MOVE);
			...
			for (uri_it = 0; uri_it < _vala_array_length (_tmp7_); uri_it = uri_it + 1) {
				...
				uri = _tmp9_;
				{
					...
					if (_tmp11_) {
						...
						add = (_tmp17_ = _tmp16_, _g_free0 (_tmp15_), _tmp17_);
						if (add != NULL) {
							gint _tmp18_;
				...
				for (uri_it = 0; uri_it < _vala_array_length (_tmp20_); uri_it = uri_it + 1) {
					...
					uri = _tmp22_;
					{
						...
						if (_tmp24_) {
							...
							add = (_tmp30_ = _tmp29_, _g_free0 (_tmp28_), _tmp30_);
							if (add != NULL) {
