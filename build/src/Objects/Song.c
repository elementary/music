/* Song.c generated by valac 0.11.7, the Vala compiler
...
gchar* beat_box_song_pretty_length (BeatBoxSong* self) {
	...
	_tmp5_ = g_strdup_printf ("%i", minute);
	_tmp6_ = _tmp5_;
	_tmp7_ = g_strconcat (_tmp6_, ":", NULL);
	_tmp8_ = _tmp7_;
	_tmp9_ = g_strconcat (_tmp8_, _tmp0_, NULL);
	_tmp10_ = _tmp9_;
	_g_free0 (_tmp8_);
	_g_free0 (_tmp6_);
	result = _tmp10_;
...
gchar* beat_box_song_pretty_last_played (BeatBoxSong* self) {
	...
	g_time_local ((time_t) _tmp0_, &_tmp1_);
	_tmp2_ = _tmp1_;
	t = _tmp2_;
...
void beat_box_song_set_file_directory (BeatBoxSong* self, const gchar* value) {
	...
	self->priv->_file_directory = _tmp0_;
...
void beat_box_song_set_lastfm_url (BeatBoxSong* self, const gchar* value) {
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = g_strdup (value);
	_g_free0 (self->priv->_lastfm_url);
	self->priv->_lastfm_url = _tmp0_;
	g_object_notify ((GObject *) self, "lastfm-url");
}
...
static void beat_box_song_class_init (BeatBoxSongClass * klass) {
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), BEAT_BOX_SONG_LASTFM_URL, g_param_spec_string ("lastfm-url", "lastfm-url", "lastfm-url", NULL, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE));
}
...
static void _vala_beat_box_song_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		...
		break;
		case BEAT_BOX_SONG_LASTFM_URL:
		g_value_set_string (value, beat_box_song_get_lastfm_url (self));
		break;
		default:
...
static void _vala_beat_box_song_set_property (GObject * object, guint property_id, const GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		...
		break;
		case BEAT_BOX_SONG_LASTFM_URL:
		beat_box_song_set_lastfm_url (self, g_value_get_string (value));
		break;
		default:
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
		break;
