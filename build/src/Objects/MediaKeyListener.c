/* MediaKeyListener.c generated by valac 0.11.6, the Vala compiler
...
BeatBoxMediaKeyListener* beat_box_media_key_listener_construct (GType object_type, BeatBoxLibraryManager* lmm, BeatBoxLibraryWindow* lww) {
	...
	if (connection != NULL) {
		...
		DBusGProxy* _tmp6_;
		_tmp5_ = dbus_g_proxy_new_for_name (connection, "org.gnome.SettingsDaemon", "/org/gnome/SettingsDaemon/MediaKeys", "org.gnome.SettingsDaemon.MediaKeys");
		_tmp6_ = _tmp5_;
		_g_object_unref0 (self->priv->media_object);
		self->priv->media_object = _tmp6_;
