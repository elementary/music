/* SongInfo.c generated by valac 0.11.5, the Vala compiler
...
BeatBoxSongInfo* beat_box_song_info_construct (GType object_type) {
	...
	_tmp7_ = last_fm_artist_info_new_basic ();
	_tmp8_ = _tmp7_;
	_g_object_unref0 (self->artist);
	self->artist = _tmp8_;
	_tmp9_ = last_fm_track_info_new ();
	_tmp10_ = _tmp9_;
	_g_object_unref0 (self->track);
	self->track = _tmp10_;
	_tmp11_ = last_fm_album_info_new_basic ();
	_tmp12_ = _tmp11_;
...
gchar* beat_box_song_info_update_file (BeatBoxSongInfo* self, LastFMArtistInfo* art, LastFMTrackInfo* tra, LastFMAlbumInfo* alb, BeatBoxSong* s) {
	...
	_tmp10_ = g_strconcat (_tmp9_, "/.beatbox/song_info.html", NULL);
	...
	result = g_strconcat (_tmp15_, "/.beatbox/song_info.html", NULL);
	_g_free0 (html);
	return result;
}
