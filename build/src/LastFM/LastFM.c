/* LastFM.c generated by valac 0.11.7, the Vala compiler
...
gchar* last_fm_core_generate_signature (LastFMCore* self, const gchar* token, const gchar* method) {
	...
	_tmp3_ = _tmp2_;
	_tmp4_ = g_strconcat (_tmp3_, token, NULL);
	_tmp5_ = _tmp4_;
	_tmp6_ = g_strconcat (_tmp5_, LAST_FM_CORE_secret, NULL);
	_tmp7_ = _tmp6_;
	_tmp8_ = last_fm_core_generate_md5 (self, _tmp7_);
	_tmp9_ = _tmp8_;
	_g_free0 (_tmp7_);
	_g_free0 (_tmp5_);
	_g_free0 (_tmp3_);
...
gchar* last_fm_core_getSessionKey (LastFMCore* self, const gchar* token) {
	...
	_tmp4_ = g_strconcat (_tmp3_, "&token=", NULL);
	_tmp5_ = _tmp4_;
	_tmp6_ = g_strconcat (_tmp5_, token, NULL);
	_tmp7_ = _tmp6_;
	_g_free0 (_tmp5_);
	_g_free0 (_tmp3_);
	_g_free0 (_tmp1_);
	...
	_tmp9_ = xmlDocGetRootElement (doc);
	root = _tmp9_;
	if (root == NULL) {
		result = NULL;
		_g_free0 (url);
