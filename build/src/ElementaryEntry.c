/* ElementaryEntry.c generated by valac 0.11.6, the Vala compiler
...
ElementaryWidgetsElementarySearchEntry* elementary_widgets_elementary_search_entry_construct (GType object_type, const gchar* hint_string) {
	...
	_tmp0_ = g_strdup (hint_string);
	_tmp1_ = _tmp0_;
	_g_free0 (((ElementaryWidgetsElementaryEntry*) self)->hint_string);
	((ElementaryWidgetsElementaryEntry*) self)->hint_string = _tmp1_;
	return self;
}
