/* DataBaseManager.c generated by valac 0.11.7, the Vala compiler
...
")", (gssize) (-1), &_inner_error_);
	...
	sql_heavy_queryable_execute ((SQLHeavyQueryable*) self->priv->_db, "CREATE TABLE playlists (`name` TEXT, `songs` TEXT, 'sort_column' TEXT," \
" 'sort_direction' TEXT, 'columns' TEXT)", (gssize) (-1), &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch0_sql_heavy_error;
		}
...
"XT, 'limit' INT, 'limit_amount' INT, 'sort_column' TEXT, 'sort_directi" \
"on' TEXT, 'columns' TEXT)", (gssize) (-1), &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch0_sql_heavy_error;
		}
...
" `length` INT, `samplerate` INT, `rating` INT, `playcount` INT, 'skipc" \
"ount' INT, `dateadded` INT, `lastplayed` INT)", (gssize) (-1), &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch0_sql_heavy_error;
		}
...
void beat_box_data_base_manager_load_db (BeatBoxDataBaseManager* self) {
	...
	_tmp4_ = _tmp3_;
	_g_free0 (_tmp2_);
	beatbox_folder = _tmp4_;
	_tmp5_ = g_file_query_exists (beatbox_folder, NULL);
	if (!_tmp5_) {
		...
		__catch1_g_error:
		{
			...
			err = _inner_error_;
			_inner_error_ = NULL;
			fprintf (stdout, "CRITICAL: Could not create beatbox folder in data directory: %s\n", err->message);
			_g_error_free0 (err);
		}
		__finally1:
		if (_inner_error_ != NULL) {
	...
	_tmp6_ = g_file_get_path (beatbox_folder);
	_tmp7_ = _tmp6_;
	_tmp8_ = g_strconcat (_tmp7_, "/beatbox_db.db", NULL);
	_tmp9_ = _tmp8_;
	...
	_g_free0 (_tmp7_);
	db_file = _tmp11_;
	_tmp12_ = g_file_query_exists (db_file, NULL);
	if (!_tmp12_) {
		need_create = TRUE;
	}
	if (self->priv->write) {
		_tmp13_ = !self->priv->create;
	} else {
		_tmp13_ = FALSE;
	}
	if (_tmp13_) {
		gchar* _tmp14_ = NULL;
		gchar* _tmp15_;
		SQLHeavyDatabase* _tmp16_ = NULL;
		SQLHeavyDatabase* _tmp17_;
		SQLHeavyDatabase* _tmp18_;
		_tmp14_ = g_file_get_path (db_file);
		_tmp15_ = _tmp14_;
		_tmp16_ = sql_heavy_database_new (_tmp15_, SQL_HEAVY_FILE_MODE_READ | SQL_HEAVY_FILE_MODE_WRITE, &_inner_error_);
		_tmp17_ = _tmp16_;
		_g_free0 (_tmp15_);
		_tmp18_ = _tmp17_;
		if (_inner_error_ != NULL) {
		...
		if (_tmp19_) {
			...
			_tmp20_ = g_file_get_path (db_file);
			_tmp21_ = _tmp20_;
			...
			_g_object_unref0 (self->priv->_db);
			self->priv->_db = _tmp24_;
		} else {
			gboolean _tmp25_ = FALSE;
			if (self->priv->write) {
				_tmp25_ = self->priv->create;
			} else {
				_tmp25_ = FALSE;
			}
			if (_tmp25_) {
				gchar* _tmp26_ = NULL;
				gchar* _tmp27_;
				SQLHeavyDatabase* _tmp28_ = NULL;
				SQLHeavyDatabase* _tmp29_;
				SQLHeavyDatabase* _tmp30_;
				_tmp26_ = g_file_get_path (db_file);
				_tmp27_ = _tmp26_;
				_tmp28_ = sql_heavy_database_new (_tmp27_, (SQL_HEAVY_FILE_MODE_READ | SQL_HEAVY_FILE_MODE_WRITE) | SQL_HEAVY_FILE_MODE_CREATE, &_inner_error_);
				_tmp29_ = _tmp28_;
				_g_free0 (_tmp27_);
				_tmp30_ = _tmp29_;
				if (_inner_error_ != NULL) {
				...
				_g_object_unref0 (self->priv->_db);
				self->priv->_db = _tmp30_;
			} else {
				gchar* _tmp31_ = NULL;
				gchar* _tmp32_;
				SQLHeavyDatabase* _tmp33_ = NULL;
				SQLHeavyDatabase* _tmp34_;
				SQLHeavyDatabase* _tmp35_;
				_tmp31_ = g_file_get_path (db_file);
				_tmp32_ = _tmp31_;
				_tmp33_ = sql_heavy_database_new (_tmp32_, SQL_HEAVY_FILE_MODE_READ, &_inner_error_);
				_tmp34_ = _tmp33_;
				_g_free0 (_tmp32_);
				_tmp35_ = _tmp34_;
				if (_inner_error_ != NULL) {
...
void beat_box_data_base_manager_begin_transaction (BeatBoxDataBaseManager* self, const gchar* script) {
	...
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, script, &_inner_error_);
	_tmp3_ = _tmp2_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch3_sql_heavy_error;
...
void beat_box_data_base_manager_drop_table (BeatBoxDataBaseManager* self, const gchar* table) {
	...
	_tmp3_ = _tmp2_;
	sql_heavy_queryable_execute ((SQLHeavyQueryable*) self->priv->_db, _tmp3_, (gssize) (-1), &_inner_error_);
	_g_free0 (_tmp3_);
	_g_free0 (_tmp1_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	self->priv->index = 0;
	{
		...
		}
		{
			...
			while (TRUE) {
				...
				_tmp6_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 0, &_inner_error_);
				_tmp7_ = _tmp6_;
				if (_inner_error_ != NULL) {
				...
				if (_tmp9_) {
					...
					gchar* _tmp11_;
					gchar* _tmp12_;
					_tmp10_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 0, &_inner_error_);
					_tmp11_ = _tmp10_;
					if (_inner_error_ != NULL) {
						_g_object_unref0 (tvc);
						_g_object_unref0 (results);
					...
					_tmp12_ = _tmp11_;
					_tmp5_ = g_strcmp0 (_tmp12_, "Rating") != 0;
					_g_free0 (_tmp12_);
				} else {
					_tmp5_ = FALSE;
				}
				if (_tmp5_) {
					...
					_tmp13_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 0, &_inner_error_);
					_tmp14_ = _tmp13_;
					if (_inner_error_ != NULL) {
						_g_object_unref0 (tvc);
						_g_object_unref0 (results);
					...
					_tmp18_ = gtk_tree_view_column_new_with_attributes (_tmp15_, (GtkCellRenderer*) _tmp17_, "text", self->priv->index, NULL, NULL);
					_g_object_unref0 (tvc);
					tvc = g_object_ref_sink (_tmp18_);
					...
					_tmp19_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 0, &_inner_error_);
					_tmp20_ = _tmp19_;
					if (_inner_error_ != NULL) {
						_g_object_unref0 (tvc);
						_g_object_unref0 (results);
					...
					_tmp24_ = gtk_tree_view_column_new_with_attributes (_tmp21_, (GtkCellRenderer*) _tmp23_, "pixbuf", self->priv->index, NULL, NULL);
					_g_object_unref0 (tvc);
					tvc = g_object_ref_sink (_tmp24_);
					_g_object_unref0 (_tmp23_);
					_g_free0 (_tmp21_);
				}
				_tmp25_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 1, &_inner_error_);
				_tmp26_ = _tmp25_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (tvc);
					_g_object_unref0 (results);
				...
				gtk_tree_view_column_set_visible (tvc, _tmp26_ == 1);
				_tmp27_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 2, &_inner_error_);
				_tmp28_ = _tmp27_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (tvc);
					_g_object_unref0 (results);
				...
				gtk_tree_view_column_set_fixed_width (tvc, _tmp28_);
...
void beat_box_data_base_manager_initialize_columns (BeatBoxDataBaseManager* self) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "INSERT INTO `song_list_columns` (`title`, `visible`, `width`) VALUES (" \
":title, :visible, :width);", &_inner_error_);
	...
	_tmp4_ = sql_heavy_query_execute (self->priv->query, NULL, &_inner_error_, NULL);
	_tmp5_ = _tmp4_;
	...
	sql_heavy_query_set_string (self->priv->query, ":title", "visible", &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch7_sql_heavy_error;
		}
	...
	sql_heavy_query_set_int (self->priv->query, ":width", 24, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch7_sql_heavy_error;
		}
	...
	sql_heavy_query_set_int (self->priv->query, ":width", 90, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch7_sql_heavy_error;
		}
	...
	sql_heavy_query_set_string (self->priv->query, ":title", "Plays", &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch7_sql_heavy_error;
		}
	...
	sql_heavy_query_set_string (self->priv->query, ":title", "Skips", &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch7_sql_heavy_error;
		}
...
":title, :visible, :width);", &_inner_error_);
	...
	self->priv->query = _tmp3_;
	{
		...
		gint _tvc_size;
		gint _tvc_index;
		_tmp4_ = _g_object_ref0 (columns);
		_tvc_list = _tmp4_;
		_tmp5_ = gee_collection_get_size ((GeeCollection*) _tvc_list);
		_tvc_size = _tmp5_;
		_tvc_index = -1;
		while (TRUE) {
			...
			_tmp6_ = gee_abstract_list_get ((GeeAbstractList*) _tvc_list, _tvc_index);
			tvc = (GtkTreeViewColumn*) _tmp6_;
			_tmp7_ = gtk_tree_view_column_get_title (tvc);
			fprintf (stdout, "saving column %s\n", _tmp7_);
			_tmp8_ = gtk_tree_view_column_get_title (tvc);
			sql_heavy_query_set_string (self->priv->query, ":title", _tmp8_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (tvc);
			...
			_tmp10_ = gtk_tree_view_column_get_visible (tvc);
			if (_tmp10_) {
				_tmp9_ = 1;
			} else {
				_tmp9_ = 0;
			}
			sql_heavy_query_set_int (self->priv->query, ":visible", _tmp9_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (tvc);
				_g_object_unref0 (_tvc_list);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp12_ = gtk_tree_view_column_get_width (tvc);
			if (_tmp12_ == 0) {
				_tmp11_ = 50;
			} else {
				gint _tmp13_;
				_tmp13_ = gtk_tree_view_column_get_width (tvc);
				_tmp11_ = _tmp13_;
			}
			sql_heavy_query_set_int (self->priv->query, ":width", _tmp11_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (tvc);
				_g_object_unref0 (_tvc_list);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	}
	{
		...
		}
		{
			...
			while (TRUE) {
				...
				beat_box_song_set_skip_count (s, _tmp43_);
				...
				beat_box_song_set_date_added (s, _tmp45_);
				_tmp46_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 16, &_inner_error_);
				_tmp47_ = _tmp46_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (s);
					_g_object_unref0 (results);
				...
				beat_box_song_set_last_played (s, _tmp47_);
...
void beat_box_data_base_manager_save_songs (BeatBoxDataBaseManager* self, GeeCollection* songs) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "INSERT INTO `songs` (`file`, `title`, `artist`, `album`, `genre`, `com" \
"ment`, `year`, `track`, `bitrate`, `length`, `samplerate`, `rating`, `" \
"playcount`, 'skipcount', `dateadded`, `lastplayed`) VALUES (:file, :ti" \
"tle, :artist, :album, :genre, :comment, :year, :track, :bitrate, :leng" \
"th, :samplerate, :rating, :playcount, :skipcount, :dateadded, :lastpla" \
"yed);", &_inner_error_);
	_tmp3_ = _tmp2_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	self->priv->query = _tmp3_;
	{
		...
		while (TRUE) {
			...
			gint _tmp21_;
			gint _tmp22_;
			SQLHeavyQueryResult* _tmp23_ = NULL;
			...
			sql_heavy_query_set_string (self->priv->query, ":file", _tmp7_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
			...
			sql_heavy_query_set_string (self->priv->query, ":artist", _tmp9_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			sql_heavy_query_set_string (self->priv->query, ":album", _tmp10_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp11_ = beat_box_song_get_genre (s);
			sql_heavy_query_set_string (self->priv->query, ":genre", _tmp11_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			sql_heavy_query_set_string (self->priv->query, ":comment", _tmp12_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp13_ = beat_box_song_get_year (s);
			sql_heavy_query_set_int (self->priv->query, ":year", _tmp13_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			sql_heavy_query_set_int (self->priv->query, ":track", _tmp14_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp15_ = beat_box_song_get_bitrate (s);
			sql_heavy_query_set_int (self->priv->query, ":bitrate", _tmp15_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp16_ = beat_box_song_get_length (s);
			sql_heavy_query_set_int (self->priv->query, ":length", _tmp16_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp17_ = beat_box_song_get_samplerate (s);
			sql_heavy_query_set_int (self->priv->query, ":samplerate", _tmp17_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp18_ = beat_box_song_get_rating (s);
			sql_heavy_query_set_int (self->priv->query, ":rating", _tmp18_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp19_ = beat_box_song_get_play_count (s);
			sql_heavy_query_set_int (self->priv->query, ":playcount", _tmp19_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp20_ = beat_box_song_get_skip_count (s);
			sql_heavy_query_set_int (self->priv->query, ":skipcount", _tmp20_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp21_ = beat_box_song_get_date_added (s);
			sql_heavy_query_set_int (self->priv->query, ":dateadded", _tmp21_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp22_ = beat_box_song_get_last_played (s);
			sql_heavy_query_set_int (self->priv->query, ":lastplayed", _tmp22_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp23_ = sql_heavy_query_execute (self->priv->query, NULL, &_inner_error_, NULL);
			_tmp24_ = _tmp23_;
...
void beat_box_data_base_manager_add_song_mass (BeatBoxDataBaseManager* self, BeatBoxSong* s, gboolean saving) {
	...
	_tmp13_ = beat_box_song_get_skip_count (s);
	sql_heavy_query_set_int (self->priv->query, ":skipcount", _tmp13_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch11_sql_heavy_error;
		}
	...
	_tmp14_ = beat_box_song_get_date_added (s);
	sql_heavy_query_set_int (self->priv->query, ":dateadded", _tmp14_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch11_sql_heavy_error;
		}
	...
	_tmp15_ = beat_box_song_get_last_played (s);
	sql_heavy_query_set_int (self->priv->query, ":lastplayed", _tmp15_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch11_sql_heavy_error;
		}
	...
	if (saving) {
		...
		sql_heavy_query_set_int (self->priv->query, ":rowid", _tmp16_, &_inner_error_);
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == SQL_HEAVY_ERROR) {
				goto __catch11_sql_heavy_error;
			}
	...
	__catch11_sql_heavy_error:
	{
		...
		err = _inner_error_;
		_inner_error_ = NULL;
		_tmp19_ = beat_box_song_get_rowid (s);
...
void beat_box_data_base_manager_remove_songs (BeatBoxDataBaseManager* self, GeeCollection* songs) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "DELETE FROM `songs` WHERE file=:file", &_inner_error_);
	query = _tmp2_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch12_sql_heavy_error;
	...
	}
	{
		...
		GeeIterator* _s_it;
		_tmp3_ = gee_iterable_iterator ((GeeIterable*) songs);
		_s_it = _tmp3_;
		while (TRUE) {
			gboolean _tmp4_;
			...
			_tmp6_ = sql_heavy_query_execute (query, NULL, &_inner_error_, NULL);
			_tmp7_ = _tmp6_;
			_g_object_unref0 (_tmp7_);
			if (_inner_error_ != NULL) {
				_g_free0 (s);
	...
	__catch12_sql_heavy_error:
	{
		...
		err = _inner_error_;
		_inner_error_ = NULL;
		fprintf (stdout, "Could not remove song from db: %s\n", err->message);
		_g_error_free0 (err);
	}
	__finally12:
	if (_inner_error_ != NULL) {
...
void beat_box_data_base_manager_update_songs (BeatBoxDataBaseManager* self, GeeCollection* songs) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "UPDATE `songs` SET file=:file, title=:title, artist=:artist, album=:al" \
"bum, genre=:genre, comment=:comment, year=:year, track=:track, bitrate" \
"=:bitrate, length=:length, samplerate=:samplerate, rating=:rating, pla" \
"ycount=:playcount, skipcount=:skipcount, dateadded=:dateadded, lastpla" \
"yed=:lastplayed WHERE rowid=:rowid", &_inner_error_);
	query = _tmp2_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch13_sql_heavy_error;
	...
	}
	{
		...
		while (TRUE) {
			...
			if (_tmp6_ != 0) {
				...
				_tmp9_ = _tmp8_;
				sql_heavy_query_set_string (query, ":rowid", _tmp9_, &_inner_error_);
				_g_free0 (_tmp9_);
				if (_inner_error_ != NULL) {
					_g_object_unref0 (s);
					_g_object_unref0 (_s_it);
			...
			_tmp10_ = beat_box_song_get_file (s);
			sql_heavy_query_set_string (query, ":file", _tmp10_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_string (query, ":title", _tmp11_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_string (query, ":artist", _tmp12_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_string (query, ":album", _tmp13_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp14_ = beat_box_song_get_genre (s);
			sql_heavy_query_set_string (query, ":genre", _tmp14_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp15_ = beat_box_song_get_comment (s);
			sql_heavy_query_set_string (query, ":comment", _tmp15_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp16_ = beat_box_song_get_year (s);
			sql_heavy_query_set_int (query, ":year", _tmp16_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp17_ = beat_box_song_get_track (s);
			sql_heavy_query_set_int (query, ":track", _tmp17_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp18_ = beat_box_song_get_bitrate (s);
			sql_heavy_query_set_int (query, ":bitrate", _tmp18_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp19_ = beat_box_song_get_length (s);
			sql_heavy_query_set_int (query, ":length", _tmp19_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp20_ = beat_box_song_get_samplerate (s);
			sql_heavy_query_set_int (query, ":samplerate", _tmp20_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp21_ = beat_box_song_get_rating (s);
			sql_heavy_query_set_int (query, ":rating", _tmp21_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp22_ = beat_box_song_get_play_count (s);
			sql_heavy_query_set_int (query, ":playcount", _tmp22_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp23_ = beat_box_song_get_skip_count (s);
			sql_heavy_query_set_int (query, ":skipcount", _tmp23_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":dateadded", _tmp24_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":lastplayed", _tmp25_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
	...
	}
	{
		...
		}
		{
			...
			while (TRUE) {
				...
				_tmp18_ = _tmp17_;
				beat_box_tree_view_setup_set_sort_column (p->tvs, _tmp18_);
				_g_free0 (_tmp18_);
				_tmp19_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 4, &_inner_error_);
				_tmp20_ = _tmp19_;
				if (_inner_error_ != NULL) {
				...
				_tmp21_ = _tmp20_;
				beat_box_tree_view_setup_set_sort_direction_from_string (p->tvs, _tmp21_);
				_g_free0 (_tmp21_);
				_tmp22_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 5, &_inner_error_);
				_tmp23_ = _tmp22_;
				if (_inner_error_ != NULL) {
				...
				_tmp24_ = _tmp23_;
				beat_box_tree_view_setup_import_columns (p->tvs, _tmp24_);
				_g_free0 (_tmp24_);
...
void beat_box_data_base_manager_save_playlists (BeatBoxDataBaseManager* self, GeeCollection* playlists) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "INSERT INTO `playlists` (`name`, `songs`, 'sort_column', 'sort_directi" \
"on', 'columns') VALUES (:name, :songs, :sort_column, :sort_direction, " \
":columns);", &_inner_error_);
	_tmp3_ = _tmp2_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch15_sql_heavy_error;
	...
	self->priv->query = _tmp3_;
	{
		GeeIterator* _tmp4_ = NULL;
		GeeIterator* _p_it;
		_tmp4_ = gee_iterable_iterator ((GeeIterable*) playlists);
		_p_it = _tmp4_;
		while (TRUE) {
			gboolean _tmp5_;
			gpointer _tmp6_ = NULL;
			...
			p = (BeatBoxPlaylist*) _tmp6_;
			_tmp7_ = beat_box_playlist_get_name (p);
			sql_heavy_query_set_string (self->priv->query, ":name", _tmp7_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (p);
			...
			_tmp8_ = beat_box_playlist_songs_to_string (p);
			_tmp9_ = _tmp8_;
			sql_heavy_query_set_string (self->priv->query, ":songs", _tmp9_, &_inner_error_);
			_g_free0 (_tmp9_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (p);
				_g_object_unref0 (_p_it);
			...
			_tmp10_ = beat_box_tree_view_setup_get_sort_column (p->tvs);
			sql_heavy_query_set_string (self->priv->query, ":sort_column", _tmp10_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (p);
				_g_object_unref0 (_p_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp11_ = beat_box_tree_view_setup_sort_direction_to_string (p->tvs);
			_tmp12_ = _tmp11_;
			sql_heavy_query_set_string (self->priv->query, ":sort_direction", _tmp12_, &_inner_error_);
			_g_free0 (_tmp12_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (p);
				_g_object_unref0 (_p_it);
			...
			_tmp13_ = beat_box_tree_view_setup_columns_to_string (p->tvs);
			_tmp14_ = _tmp13_;
			sql_heavy_query_set_string (self->priv->query, ":columns", _tmp14_, &_inner_error_);
			_g_free0 (_tmp14_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (p);
				_g_object_unref0 (_p_it);
...
void beat_box_data_base_manager_update_playlist (BeatBoxDataBaseManager* self, BeatBoxPlaylist* p) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "UPDATE `playlists` SET name=:name, songs=:songs, sort_column=:sort_col" \
"umn, sort_direction=:sort_direction, columns=:columns  WHERE name=:nam" \
"e", &_inner_error_);
	query = _tmp2_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp3_ = beat_box_playlist_get_name (p);
	sql_heavy_query_set_string (query, ":name", _tmp3_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch16_sql_heavy_error;
	...
	_tmp4_ = beat_box_playlist_songs_to_string (p);
	_tmp5_ = _tmp4_;
	sql_heavy_query_set_string (query, ":songs", _tmp5_, &_inner_error_);
	_g_free0 (_tmp5_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp6_ = beat_box_tree_view_setup_get_sort_column (p->tvs);
	sql_heavy_query_set_string (query, ":sort_column", _tmp6_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch16_sql_heavy_error;
	...
	_tmp7_ = beat_box_tree_view_setup_sort_direction_to_string (p->tvs);
	_tmp8_ = _tmp7_;
	sql_heavy_query_set_string (query, ":sort_direction", _tmp8_, &_inner_error_);
	_g_free0 (_tmp8_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp9_ = beat_box_tree_view_setup_columns_to_string (p->tvs);
	_tmp10_ = _tmp9_;
	sql_heavy_query_set_string (query, ":columns", _tmp10_, &_inner_error_);
	_g_free0 (_tmp10_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp11_ = sql_heavy_query_execute (query, NULL, &_inner_error_, NULL);
	_tmp12_ = _tmp11_;
	...
	}
	{
		...
		}
		{
			...
			while (TRUE) {
				...
				beat_box_smart_playlist_set_limit (p, _tmp18_);
				_tmp23_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 5, &_inner_error_);
				_tmp24_ = _tmp23_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (p);
					_g_object_unref0 (results);
				...
				beat_box_smart_playlist_set_limit_amount (p, _tmp24_);
				_tmp25_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 6, &_inner_error_);
				_tmp26_ = _tmp25_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (p);
				...
				_tmp27_ = _tmp26_;
				beat_box_tree_view_setup_set_sort_column (p->tvs, _tmp27_);
				_g_free0 (_tmp27_);
				_tmp28_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 7, &_inner_error_);
				_tmp29_ = _tmp28_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (p);
					_g_object_unref0 (results);
				...
				_tmp30_ = _tmp29_;
				beat_box_tree_view_setup_set_sort_direction_from_string (p->tvs, _tmp30_);
				_g_free0 (_tmp30_);
				_tmp31_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 8, &_inner_error_);
				_tmp32_ = _tmp31_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (p);
					_g_object_unref0 (results);
				...
				_tmp33_ = _tmp32_;
				beat_box_tree_view_setup_import_columns (p->tvs, _tmp33_);
				_g_free0 (_tmp33_);
				gee_abstract_collection_add ((GeeAbstractCollection*) rv, p);
				_g_object_unref0 (p);
			}
...
void beat_box_data_base_manager_save_smart_playlists (BeatBoxDataBaseManager* self, GeeCollection* smarts) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "INSERT INTO `smart_playlists` (`name`, `and_or`, `queries`, 'limit', '" \
"limit_amount', 'sort_column', 'sort_direction', 'columns') VALUES (:na" \
"me, :and_or, :queries, :limit, :limit_amount, :sort_column, :sort_dire" \
"ction, :columns);", &_inner_error_);
	_tmp3_ = _tmp2_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch18_sql_heavy_error;
	...
	self->priv->query = _tmp3_;
	self->priv->index = 0;
	_tmp4_ = gee_collection_get_size (smarts);
	self->priv->item_count = _tmp4_;
	{
		GeeIterator* _tmp5_ = NULL;
		GeeIterator* _s_it;
		_tmp5_ = gee_iterable_iterator ((GeeIterable*) smarts);
		_s_it = _tmp5_;
		while (TRUE) {
			gboolean _tmp6_;
			...
			_tmp9_ = beat_box_smart_playlist_get_name (s);
			...
			_tmp10_ = beat_box_smart_playlist_get_conditional (s);
			sql_heavy_query_set_string (self->priv->query, ":and_or", _tmp10_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp11_ = beat_box_smart_playlist_queries_to_string (s);
			_tmp12_ = _tmp11_;
			sql_heavy_query_set_string (self->priv->query, ":queries", _tmp12_, &_inner_error_);
			_g_free0 (_tmp12_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
			...
			_tmp14_ = beat_box_smart_playlist_get_limit (s);
			if (_tmp14_) {
				_tmp13_ = 1;
			} else {
				_tmp13_ = 0;
			}
			sql_heavy_query_set_int (self->priv->query, ":limit", _tmp13_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp15_ = beat_box_smart_playlist_get_limit_amount (s);
			sql_heavy_query_set_int (self->priv->query, ":limit_amount", _tmp15_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp16_ = beat_box_tree_view_setup_get_sort_column (s->tvs);
			sql_heavy_query_set_string (self->priv->query, ":sort_column", _tmp16_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp17_ = beat_box_tree_view_setup_sort_direction_to_string (s->tvs);
			_tmp18_ = _tmp17_;
			sql_heavy_query_set_string (self->priv->query, ":sort_direction", _tmp18_, &_inner_error_);
			_g_free0 (_tmp18_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
			...
			_tmp19_ = beat_box_tree_view_setup_columns_to_string (s->tvs);
			_tmp20_ = _tmp19_;
			sql_heavy_query_set_string (self->priv->query, ":columns", _tmp20_, &_inner_error_);
			_g_free0 (_tmp20_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
			...
			_tmp21_ = sql_heavy_query_execute (self->priv->query, NULL, &_inner_error_, NULL);
			_tmp22_ = _tmp21_;
...
void beat_box_data_base_manager_update_smart_playlist (BeatBoxDataBaseManager* self, BeatBoxSmartPlaylist* p) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "UPDATE `smart_playlists` SET name=:name, and_or=:and_or, queries=:quer" \
"ies, limit=:limit, limit_amount=:limit_amount, sort_column=:sort_colum" \
"n, sort_direction=:sort_direction, columns=:columns WHERE name=:name", &_inner_error_);
	query = _tmp2_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch19_sql_heavy_error;
	...
	_tmp3_ = beat_box_smart_playlist_get_name (p);
	sql_heavy_query_set_string (query, ":name", _tmp3_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp4_ = beat_box_smart_playlist_get_conditional (p);
	sql_heavy_query_set_string (query, ":and_or", _tmp4_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch19_sql_heavy_error;
	...
	_tmp5_ = beat_box_smart_playlist_queries_to_string (p);
	_tmp6_ = _tmp5_;
	sql_heavy_query_set_string (query, ":queries", _tmp6_, &_inner_error_);
	_g_free0 (_tmp6_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp8_ = beat_box_smart_playlist_get_limit (p);
	if (_tmp8_) {
		_tmp7_ = 1;
	} else {
		_tmp7_ = 0;
	}
	sql_heavy_query_set_int (query, ":limit", _tmp7_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch19_sql_heavy_error;
	...
	_tmp9_ = beat_box_smart_playlist_get_limit_amount (p);
	sql_heavy_query_set_int (query, ":limit_amount", _tmp9_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch19_sql_heavy_error;
	...
	_tmp10_ = beat_box_tree_view_setup_get_sort_column (p->tvs);
	sql_heavy_query_set_string (query, ":sort_column", _tmp10_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch19_sql_heavy_error;
	...
	_tmp11_ = beat_box_tree_view_setup_sort_direction_to_string (p->tvs);
	_tmp12_ = _tmp11_;
	sql_heavy_query_set_string (query, ":sort_direction", _tmp12_, &_inner_error_);
	_g_free0 (_tmp12_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp13_ = beat_box_tree_view_setup_columns_to_string (p->tvs);
	_tmp14_ = _tmp13_;
	sql_heavy_query_set_string (query, ":columns", _tmp14_, &_inner_error_);
	_g_free0 (_tmp14_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp15_ = sql_heavy_query_execute (query, NULL, &_inner_error_, NULL);
	_tmp16_ = _tmp15_;
	_g_object_unref0 (_tmp16_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
...
void beat_box_data_base_manager_save_albums (BeatBoxDataBaseManager* self, GeeCollection* albums) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "INSERT INTO `albums` (`name`, 'artist', `mbid`, `url`, 'release_date'," \
...
"e);", &_inner_error_);
	...
	self->priv->query = _tmp3_;
	{
		GeeIterator* _tmp4_ = NULL;
		GeeIterator* _a_it;
		_tmp4_ = gee_iterable_iterator ((GeeIterable*) albums);
		_a_it = _tmp4_;
		while (TRUE) {
			gboolean _tmp5_;
			gpointer _tmp6_ = NULL;
			...
			gchar* _tmp14_;
			gchar* tags;
			LastFMImage* _tmp27_ = NULL;
			gchar* _tmp28_ = NULL;
			gchar* _tmp29_;
			SQLHeavyQueryResult* _tmp30_ = NULL;
			SQLHeavyQueryResult* _tmp31_;
			_tmp5_ = gee_iterator_next (_a_it);
			if (!_tmp5_) {
				break;
			}
			_tmp6_ = gee_iterator_get (_a_it);
			a = (LastFMAlbumInfo*) _tmp6_;
			_tmp7_ = last_fm_album_info_get_name (a);
			sql_heavy_query_set_string (self->priv->query, ":name", _tmp7_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
			...
			_tmp8_ = last_fm_album_info_get_artist (a);
			sql_heavy_query_set_string (self->priv->query, ":artist", _tmp8_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp9_ = last_fm_album_info_get_mbid (a);
			sql_heavy_query_set_string (self->priv->query, ":mbid", _tmp9_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp10_ = last_fm_album_info_get_url (a);
			sql_heavy_query_set_string (self->priv->query, ":url", _tmp10_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp11_ = last_fm_album_info_get_releasedate (a);
			sql_heavy_query_set_string (self->priv->query, ":release_date", _tmp11_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp12_ = last_fm_album_info_get_listeners (a);
			sql_heavy_query_set_int (self->priv->query, ":listeners", _tmp12_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp13_ = last_fm_album_info_get_playcount (a);
			sql_heavy_query_set_int (self->priv->query, ":playcount", _tmp13_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			tags = _tmp14_;
			{
				...
				gint _tag_size;
				gint _tag_index;
				_tmp15_ = last_fm_album_info_tags (a);
				_tag_list = _tmp15_;
				_tmp16_ = gee_collection_get_size ((GeeCollection*) _tag_list);
				_tag_size = _tmp16_;
				_tag_index = -1;
				while (TRUE) {
					...
					_tmp17_ = gee_abstract_list_get ((GeeAbstractList*) _tag_list, _tag_index);
					tag = (LastFMTag*) _tmp17_;
					_tmp18_ = last_fm_tag_get_tag (tag);
					_tmp19_ = g_strconcat (_tmp18_, "<value_seperator>", NULL);
					_tmp20_ = _tmp19_;
					_tmp21_ = last_fm_tag_get_url (tag);
					_tmp22_ = g_strconcat (_tmp20_, _tmp21_, NULL);
					_tmp23_ = _tmp22_;
					_tmp24_ = g_strconcat (_tmp23_, "<tag_seperator>", NULL);
					_tmp25_ = _tmp24_;
					_tmp26_ = g_strconcat (tags, _tmp25_, NULL);
					_g_free0 (tags);
					tags = _tmp26_;
					_g_free0 (_tmp25_);
					_g_free0 (_tmp23_);
			...
			_tmp27_ = last_fm_album_info_get_url_image (a);
			_tmp28_ = last_fm_image_to_string (_tmp27_);
			_tmp29_ = _tmp28_;
			sql_heavy_query_set_string (self->priv->query, ":url_image", _tmp29_, &_inner_error_);
			_g_free0 (_tmp29_);
			if (_inner_error_ != NULL) {
				_g_free0 (tags);
				_g_object_unref0 (a);
	...
	}
	{
		...
		}
		{
			...
			while (TRUE) {
				...
				a = _tmp6_;
				_tmp7_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 1, &_inner_error_);
				_tmp8_ = _tmp7_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				_tmp9_ = _tmp8_;
				last_fm_album_info_set_name (a, _tmp9_);
				_g_free0 (_tmp9_);
				...
				_tmp12_ = _tmp11_;
				last_fm_album_info_set_artist (a, _tmp12_);
				_g_free0 (_tmp12_);
				...
				_tmp15_ = _tmp14_;
				last_fm_album_info_set_mbid (a, _tmp15_);
				_g_free0 (_tmp15_);
				...
				_tmp18_ = _tmp17_;
				last_fm_album_info_set_url (a, _tmp18_);
				_g_free0 (_tmp18_);
				_tmp19_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 5, &_inner_error_);
				_tmp20_ = _tmp19_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				_tmp21_ = _tmp20_;
				last_fm_album_info_set_releasedate (a, _tmp21_);
				_g_free0 (_tmp21_);
				_tmp22_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 6, &_inner_error_);
				_tmp23_ = _tmp22_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				last_fm_album_info_set_listeners (a, _tmp23_);
				_tmp24_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 7, &_inner_error_);
				_tmp25_ = _tmp24_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				last_fm_album_info_set_playcount (a, _tmp25_);
				...
				_tmp28_ = _tmp27_ = g_strsplit (tag_string, "<tag_seperator>", 0);
				tag_strings = _tmp28_;
				tag_strings_length1 = _vala_array_length (_tmp27_);
				_tag_strings_size_ = _vala_array_length (_tmp27_);
				{
					gboolean _tmp29_;
					index = 0;
					_tmp29_ = TRUE;
					while (TRUE) {
						...
						_tmp31_ = _tmp30_ = g_strsplit (tag_strings[index], "<value_seperator>", 0);
						tag_values = _tmp31_;
						tag_values_length1 = _vala_array_length (_tmp30_);
						_tag_values_size_ = _vala_array_length (_tmp30_);
						_tmp32_ = last_fm_tag_new_with_string_and_url (tag_values[0], tag_values[1]);
						t = _tmp32_;
				...
				_tmp33_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 9, &_inner_error_);
				url_image = _tmp33_;
				if (_inner_error_ != NULL) {
				...
				if (url_image != NULL) {
					_tmp34_ = g_strcmp0 (url_image, "") != 0;
				} else {
					_tmp34_ = FALSE;
				}
				if (_tmp34_) {
					LastFMImage* _tmp35_ = NULL;
					LastFMImage* _tmp36_;
					_tmp35_ = last_fm_image_new_with_import_string (url_image);
					_tmp36_ = _tmp35_;
					last_fm_album_info_set_url_image (a, _tmp36_);
					_g_object_unref0 (_tmp36_);
				} else {
					LastFMImage* _tmp37_ = NULL;
					LastFMImage* _tmp38_;
					_tmp37_ = last_fm_image_new_basic ();
					_tmp38_ = _tmp37_;
					last_fm_album_info_set_url_image (a, _tmp38_);
	...
	}
	{
		...
		}
		{
			...
			while (TRUE) {
				...
				_tmp9_ = _tmp8_;
				last_fm_artist_info_set_name (a, _tmp9_);
				_g_free0 (_tmp9_);
				_tmp10_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 2, &_inner_error_);
				_tmp11_ = _tmp10_;
				if (_inner_error_ != NULL) {
				...
				_tmp12_ = _tmp11_;
				last_fm_artist_info_set_mbid (a, _tmp12_);
				_g_free0 (_tmp12_);
				_tmp13_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 3, &_inner_error_);
				_tmp14_ = _tmp13_;
				if (_inner_error_ != NULL) {
				...
				_tmp15_ = _tmp14_;
				last_fm_artist_info_set_url (a, _tmp15_);
				_g_free0 (_tmp15_);
				_tmp16_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 4, &_inner_error_);
				_tmp17_ = _tmp16_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				last_fm_artist_info_set_streamable (a, _tmp17_);
				_tmp18_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 5, &_inner_error_);
				_tmp19_ = _tmp18_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				last_fm_artist_info_set_listeners (a, _tmp19_);
				_tmp20_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 6, &_inner_error_);
				_tmp21_ = _tmp20_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				last_fm_artist_info_set_playcount (a, _tmp21_);
				_tmp22_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 7, &_inner_error_);
				_tmp23_ = _tmp22_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				_tmp24_ = _tmp23_;
				last_fm_artist_info_set_published (a, _tmp24_);
				_g_free0 (_tmp24_);
				_tmp25_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 8, &_inner_error_);
				_tmp26_ = _tmp25_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				_tmp27_ = _tmp26_;
				last_fm_artist_info_set_summary (a, _tmp27_);
				_g_free0 (_tmp27_);
				_tmp28_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 9, &_inner_error_);
				_tmp29_ = _tmp28_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				_tmp30_ = _tmp29_;
				last_fm_artist_info_set_content (a, _tmp30_);
				_g_free0 (_tmp30_);
				_tmp31_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 10, &_inner_error_);
				tag_string = _tmp31_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (a);
					_g_object_unref0 (results);
				...
				_tmp33_ = _tmp32_ = g_strsplit (tag_string, "<tag_seperator>", 0);
				tag_strings = _tmp33_;
				tag_strings_length1 = _vala_array_length (_tmp32_);
				_tag_strings_size_ = _vala_array_length (_tmp32_);
				{
					gboolean _tmp34_;
					index = 0;
					_tmp34_ = TRUE;
					while (TRUE) {
						...
						_tmp36_ = _tmp35_ = g_strsplit (tag_strings[index], "<value_seperator>", 0);
						tag_values = _tmp36_;
						tag_values_length1 = _vala_array_length (_tmp35_);
						_tag_values_size_ = _vala_array_length (_tmp35_);
						_tmp37_ = last_fm_tag_new_with_string_and_url (tag_values[0], tag_values[1]);
						t = _tmp37_;
				...
				_tmp38_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 11, &_inner_error_);
				sim_string = _tmp38_;
				if (_inner_error_ != NULL) {
					tag_strings = (_vala_array_free (tag_strings, tag_strings_length1, (GDestroyNotify) g_free), NULL);
					_g_free0 (tag_string);
				...
				_tmp40_ = _tmp39_ = g_strsplit (sim_string, "<similar_seperator>", 0);
				sim_strings = _tmp40_;
				sim_strings_length1 = _vala_array_length (_tmp39_);
				_sim_strings_size_ = _vala_array_length (_tmp39_);
				{
					gboolean _tmp41_;
					index = 0;
					_tmp41_ = TRUE;
					while (TRUE) {
						...
						_tmp43_ = _tmp42_ = g_strsplit (sim_strings[index], "<value_seperator>", 0);
						sim_values = _tmp43_;
						sim_values_length1 = _vala_array_length (_tmp42_);
						_sim_values_size_ = _vala_array_length (_tmp42_);
						_tmp44_ = last_fm_artist_info_new_with_artist_and_url (sim_values[0], sim_values[1]);
						sim = _tmp44_;
				...
				_tmp45_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 12, &_inner_error_);
				url_image = _tmp45_;
				if (_inner_error_ != NULL) {
				...
				if (url_image != NULL) {
					_tmp46_ = g_strcmp0 (url_image, "") != 0;
				} else {
					_tmp46_ = FALSE;
				}
				if (_tmp46_) {
					LastFMImage* _tmp47_ = NULL;
					LastFMImage* _tmp48_;
					_tmp47_ = last_fm_image_new_with_import_string (url_image);
					_tmp48_ = _tmp47_;
					last_fm_artist_info_set_url_image (a, _tmp48_);
					_g_object_unref0 (_tmp48_);
				} else {
					LastFMImage* _tmp49_ = NULL;
					LastFMImage* _tmp50_;
					_tmp49_ = last_fm_image_new_basic ();
					_tmp50_ = _tmp49_;
					last_fm_artist_info_set_url_image (a, _tmp50_);
...
void beat_box_data_base_manager_save_artists (BeatBoxDataBaseManager* self, GeeCollection* artists) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "INSERT INTO `artists` (`name`, `mbid`, `url`, 'streamable', 'listeners" \
...
"ycount, :published, :summary, :content, :tags, :similar, :url_image);", &_inner_error_);
	...
	self->priv->query = _tmp3_;
	{
		GeeIterator* _tmp4_ = NULL;
		GeeIterator* _a_it;
		_tmp4_ = gee_iterable_iterator ((GeeIterable*) artists);
		_a_it = _tmp4_;
		while (TRUE) {
			gboolean _tmp5_;
			gpointer _tmp6_ = NULL;
			...
			gchar* _tmp29_;
			gchar* similar;
			LastFMImage* _tmp42_ = NULL;
			gchar* _tmp43_ = NULL;
			gchar* _tmp44_;
			SQLHeavyQueryResult* _tmp45_ = NULL;
			SQLHeavyQueryResult* _tmp46_;
			_tmp5_ = gee_iterator_next (_a_it);
			if (!_tmp5_) {
				break;
			}
			_tmp6_ = gee_iterator_get (_a_it);
			a = (LastFMArtistInfo*) _tmp6_;
			_tmp7_ = last_fm_artist_info_get_name (a);
			sql_heavy_query_set_string (self->priv->query, ":name", _tmp7_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
			...
			_tmp8_ = last_fm_artist_info_get_mbid (a);
			sql_heavy_query_set_string (self->priv->query, ":mbid", _tmp8_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp9_ = last_fm_artist_info_get_url (a);
			sql_heavy_query_set_string (self->priv->query, ":url", _tmp9_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp10_ = last_fm_artist_info_get_streamable (a);
			sql_heavy_query_set_int (self->priv->query, ":streamable", _tmp10_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp11_ = last_fm_artist_info_get_listeners (a);
			sql_heavy_query_set_int (self->priv->query, ":listeners", _tmp11_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp12_ = last_fm_artist_info_get_playcount (a);
			sql_heavy_query_set_int (self->priv->query, ":playcount", _tmp12_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
			...
			_tmp13_ = last_fm_artist_info_get_published (a);
			sql_heavy_query_set_string (self->priv->query, ":published", _tmp13_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp14_ = last_fm_artist_info_get_summary (a);
			sql_heavy_query_set_string (self->priv->query, ":summary", _tmp14_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp15_ = last_fm_artist_info_get_content (a);
			sql_heavy_query_set_string (self->priv->query, ":content", _tmp15_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (a);
				_g_object_unref0 (_a_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			tags = _tmp16_;
			{
				...
				gint _tag_size;
				gint _tag_index;
				_tmp17_ = last_fm_artist_info_tags (a);
				_tag_list = _tmp17_;
				...
				while (TRUE) {
					...
					_tmp22_ = _tmp21_;
					_tmp23_ = last_fm_tag_get_url (tag);
			...
			similar = _tmp29_;
			{
				...
				gint _sim_size;
				gint _sim_index;
				_tmp30_ = last_fm_artist_info_similarArtists (a);
				_sim_list = _tmp30_;
				_tmp31_ = gee_collection_get_size ((GeeCollection*) _sim_list);
				_sim_size = _tmp31_;
				_sim_index = -1;
				while (TRUE) {
					...
					_tmp32_ = gee_abstract_list_get ((GeeAbstractList*) _sim_list, _sim_index);
					sim = (LastFMArtistInfo*) _tmp32_;
					_tmp33_ = last_fm_artist_info_get_name (sim);
					_tmp34_ = g_strconcat (_tmp33_, "<value_seperator>", NULL);
					_tmp35_ = _tmp34_;
					_tmp36_ = last_fm_artist_info_get_url (sim);
					_tmp37_ = g_strconcat (_tmp35_, _tmp36_, NULL);
					_tmp38_ = _tmp37_;
					_tmp39_ = g_strconcat (_tmp38_, "<similar_seperator>", NULL);
					_tmp40_ = _tmp39_;
					_tmp41_ = g_strconcat (similar, _tmp40_, NULL);
					_g_free0 (similar);
					similar = _tmp41_;
					_g_free0 (_tmp40_);
					_g_free0 (_tmp38_);
			...
			_tmp42_ = last_fm_artist_info_get_url_image (a);
			_tmp43_ = last_fm_image_to_string (_tmp42_);
			_tmp44_ = _tmp43_;
			sql_heavy_query_set_string (self->priv->query, ":url_image", _tmp44_, &_inner_error_);
			_g_free0 (_tmp44_);
			if (_inner_error_ != NULL) {
				_g_free0 (similar);
				_g_free0 (tags);
			...
			_tmp45_ = sql_heavy_query_execute (self->priv->query, NULL, &_inner_error_, NULL);
			_tmp46_ = _tmp45_;
	...
	}
	{
		...
		}
		{
			...
			while (TRUE) {
				...
				t = _tmp6_;
				_tmp7_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 1, &_inner_error_);
				_tmp8_ = _tmp7_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
					_g_object_unref0 (results);
				...
				last_fm_track_info_set_id (t, _tmp8_);
				_tmp9_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 2, &_inner_error_);
				_tmp10_ = _tmp9_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
					_g_object_unref0 (results);
				...
				_tmp11_ = _tmp10_;
				last_fm_track_info_set_name (t, _tmp11_);
				_g_free0 (_tmp11_);
				_tmp12_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 3, &_inner_error_);
				_tmp13_ = _tmp12_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
					_g_object_unref0 (results);
				...
				_tmp14_ = _tmp13_;
				last_fm_track_info_set_artist (t, _tmp14_);
				_g_free0 (_tmp14_);
				_tmp15_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 4, &_inner_error_);
				_tmp16_ = _tmp15_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
					_g_object_unref0 (results);
				...
				_tmp17_ = _tmp16_;
				last_fm_track_info_set_url (t, _tmp17_);
				_g_free0 (_tmp17_);
				_tmp18_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 5, &_inner_error_);
				_tmp19_ = _tmp18_;
				if (_inner_error_ != NULL) {
				...
				last_fm_track_info_set_duration (t, _tmp19_);
				_tmp20_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 6, &_inner_error_);
				_tmp21_ = _tmp20_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
				...
				last_fm_track_info_set_streamable (t, _tmp21_);
				_tmp22_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 7, &_inner_error_);
				_tmp23_ = _tmp22_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
					_g_object_unref0 (results);
				...
				last_fm_track_info_set_listeners (t, _tmp23_);
				_tmp24_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 8, &_inner_error_);
				_tmp25_ = _tmp24_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
					_g_object_unref0 (results);
				...
				last_fm_track_info_set_playcount (t, _tmp25_);
				_tmp26_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 9, &_inner_error_);
				_tmp27_ = _tmp26_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
					_g_object_unref0 (results);
				...
				_tmp28_ = _tmp27_;
				last_fm_track_info_set_summary (t, _tmp28_);
				_g_free0 (_tmp28_);
				_tmp29_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 10, &_inner_error_);
				_tmp30_ = _tmp29_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
					_g_object_unref0 (results);
				...
				_tmp31_ = _tmp30_;
				last_fm_track_info_set_content (t, _tmp31_);
				_g_free0 (_tmp31_);
				_tmp32_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 11, &_inner_error_);
				tag_string = _tmp32_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (t);
					_g_object_unref0 (results);
...
void beat_box_data_base_manager_save_tracks (BeatBoxDataBaseManager* self, GeeCollection* tracks) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp1_;
	_tmp2_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "INSERT INTO `tracks` ('id', `name`, `artist`, `url`, 'duration', 'stre" \
...
"ycount, :summary, :content, :tags);", &_inner_error_);
	...
	self->priv->query = _tmp3_;
	{
		GeeIterator* _tmp4_ = NULL;
		GeeIterator* _t_it;
		_tmp4_ = gee_iterable_iterator ((GeeIterable*) tracks);
		_t_it = _tmp4_;
		while (TRUE) {
			gboolean _tmp5_;
			gpointer _tmp6_ = NULL;
			...
			SQLHeavyQueryResult* _tmp30_ = NULL;
			SQLHeavyQueryResult* _tmp31_;
			_tmp5_ = gee_iterator_next (_t_it);
			if (!_tmp5_) {
				break;
			}
			_tmp6_ = gee_iterator_get (_t_it);
			t = (LastFMTrackInfo*) _tmp6_;
			_tmp7_ = last_fm_track_info_get_id (t);
			sql_heavy_query_set_int (self->priv->query, ":id", _tmp7_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (t);
			...
			_tmp8_ = last_fm_track_info_get_name (t);
			sql_heavy_query_set_string (self->priv->query, ":name", _tmp8_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (t);
				_g_object_unref0 (_t_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp9_ = last_fm_track_info_get_artist (t);
			sql_heavy_query_set_string (self->priv->query, ":artist", _tmp9_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (t);
				_g_object_unref0 (_t_it);
			...
			_tmp10_ = last_fm_track_info_get_url (t);
			sql_heavy_query_set_string (self->priv->query, ":url", _tmp10_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (t);
				_g_object_unref0 (_t_it);
			...
			_tmp11_ = last_fm_track_info_get_duration (t);
			sql_heavy_query_set_int (self->priv->query, ":duration", _tmp11_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (t);
				_g_object_unref0 (_t_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp12_ = last_fm_track_info_get_streamable (t);
			...
			_tmp13_ = last_fm_track_info_get_listeners (t);
			...
			_tmp14_ = last_fm_track_info_get_playcount (t);
			...
			_tmp15_ = last_fm_track_info_get_summary (t);
			sql_heavy_query_set_string (self->priv->query, ":summary", _tmp15_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (t);
				_g_object_unref0 (_t_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp16_ = last_fm_track_info_get_content (t);
			sql_heavy_query_set_string (self->priv->query, ":content", _tmp16_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (t);
				_g_object_unref0 (_t_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			tags = _tmp17_;
			{
				...
				gint _tag_size;
				gint _tag_index;
				_tmp18_ = last_fm_track_info_tags (t);
				_tag_list = _tmp18_;
				_tmp19_ = gee_collection_get_size ((GeeCollection*) _tag_list);
				_tag_size = _tmp19_;
				_tag_index = -1;
				while (TRUE) {
					...
					_tmp20_ = gee_abstract_list_get ((GeeAbstractList*) _tag_list, _tag_index);
					tag = (LastFMTag*) _tmp20_;
					_tmp21_ = last_fm_tag_get_tag (tag);
					_tmp22_ = g_strconcat (_tmp21_, "<value_seperator>", NULL);
					_tmp23_ = _tmp22_;
					...
					_tmp28_ = _tmp27_;
					_tmp29_ = g_strconcat (tags, _tmp28_, NULL);
					_g_free0 (tags);
					tags = _tmp29_;
					_g_free0 (_tmp28_);
					_g_free0 (_tmp26_);
