/* DataBaseManager.c generated by valac 0.11.6, the Vala compiler
...
void beat_box_data_base_manager_load_db (BeatBoxDataBaseManager* self) {
	...
	_tmp6_ = _tmp5_;
	_tmp7_ = g_strconcat (_tmp6_, "/beatbox_db.db", NULL);
	_tmp8_ = g_file_new_for_path (_tmp7_);
	db_file = (_tmp9_ = _tmp8_, _g_free0 (_tmp7_), _g_free0 (_tmp6_), _tmp9_);
	_tmp10_ = g_file_query_exists (db_file, NULL);
	if (!_tmp10_) {
		need_create = TRUE;
	}
	if (self->priv->write) {
		_tmp11_ = !self->priv->create;
	} else {
		_tmp11_ = FALSE;
	}
	if (_tmp11_) {
		gchar* _tmp12_ = NULL;
		gchar* _tmp13_;
		SQLHeavyDatabase* _tmp14_ = NULL;
		SQLHeavyDatabase* _tmp15_;
		SQLHeavyDatabase* _tmp16_;
		SQLHeavyDatabase* _tmp17_;
		_tmp12_ = g_file_get_path (db_file);
		_tmp13_ = _tmp12_;
		_tmp14_ = sql_heavy_database_new (_tmp13_, SQL_HEAVY_FILE_MODE_READ | SQL_HEAVY_FILE_MODE_WRITE, &_inner_error_);
		_tmp16_ = (_tmp15_ = _tmp14_, _g_free0 (_tmp13_), _tmp15_);
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == SQL_HEAVY_ERROR) {
		...
		self->priv->_db = _tmp17_;
	} else {
		gboolean _tmp18_ = FALSE;
		if (!self->priv->write) {
			_tmp18_ = self->priv->create;
		} else {
			_tmp18_ = FALSE;
		}
		if (_tmp18_) {
			gchar* _tmp19_ = NULL;
			gchar* _tmp20_;
			SQLHeavyDatabase* _tmp21_ = NULL;
			SQLHeavyDatabase* _tmp22_;
			SQLHeavyDatabase* _tmp23_;
			SQLHeavyDatabase* _tmp24_;
			_tmp19_ = g_file_get_path (db_file);
			_tmp20_ = _tmp19_;
			_tmp21_ = sql_heavy_database_new (_tmp20_, SQL_HEAVY_FILE_MODE_READ | SQL_HEAVY_FILE_MODE_CREATE, &_inner_error_);
			_tmp23_ = (_tmp22_ = _tmp21_, _g_free0 (_tmp20_), _tmp22_);
			if (_inner_error_ != NULL) {
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
					goto __catch2_sql_heavy_error;
				}
			...
			if (_tmp25_) {
				...
				_tmp30_ = (_tmp29_ = _tmp28_, _g_free0 (_tmp27_), _tmp29_);
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == SQL_HEAVY_ERROR) {
						goto __catch2_sql_heavy_error;
					}
				...
				_tmp31_ = _tmp30_;
				_g_object_unref0 (self->priv->_db);
				self->priv->_db = _tmp31_;
			} else {
				gchar* _tmp32_ = NULL;
				gchar* _tmp33_;
				SQLHeavyDatabase* _tmp34_ = NULL;
				SQLHeavyDatabase* _tmp35_;
				SQLHeavyDatabase* _tmp36_;
				SQLHeavyDatabase* _tmp37_;
				_tmp32_ = g_file_get_path (db_file);
				_tmp33_ = _tmp32_;
				_tmp34_ = sql_heavy_database_new (_tmp33_, SQL_HEAVY_FILE_MODE_READ, &_inner_error_);
				_tmp36_ = (_tmp35_ = _tmp34_, _g_free0 (_tmp33_), _tmp35_);
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == SQL_HEAVY_ERROR) {
						goto __catch2_sql_heavy_error;
					}
	...
	self->priv->index = 0;
	{
		...
		}
		{
			...
			while (TRUE) {
				...
				_tmp8_ = _tmp7_;
				if ((_tmp9_ = g_strcmp0 (_tmp8_, " ") != 0, _g_free0 (_tmp8_), _tmp9_)) {
					gchar* _tmp10_ = NULL;
					gchar* _tmp11_;
					gchar* _tmp12_;
				...
				if (_tmp5_) {
					...
					_tmp20_ = sql_heavy_record_fetch_string ((SQLHeavyRecord*) results, 0, &_inner_error_);
					_tmp21_ = _tmp20_;
					if (_inner_error_ != NULL) {
						_g_object_unref0 (tvc);
						_g_object_unref0 (results);
					...
					_tmp25_ = gtk_tree_view_column_new_with_attributes (_tmp22_, (GtkCellRenderer*) _tmp24_, "pixbuf", self->priv->index, NULL, NULL);
				...
				_tmp27_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 1, &_inner_error_);
				_tmp28_ = _tmp27_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (tvc);
					_g_object_unref0 (results);
				...
				gtk_tree_view_column_set_visible (tvc, _tmp28_ == 1);
				_tmp29_ = sql_heavy_record_fetch_int ((SQLHeavyRecord*) results, 2, &_inner_error_);
				_tmp30_ = _tmp29_;
				if (_inner_error_ != NULL) {
					_g_object_unref0 (tvc);
					_g_object_unref0 (results);
				...
				gtk_tree_view_column_set_fixed_width (tvc, _tmp30_);
...
void beat_box_data_base_manager_update_songs (BeatBoxDataBaseManager* self, GeeCollection* songs) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp2_;
	_tmp3_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "UPDATE `songs` SET file=:file, title=:title, artist=:artist, album=:al" \
	...
	}
	{
		...
		while (TRUE) {
			...
			if (_tmp7_ != 0) {
				...
				_tmp10_ = _tmp9_;
				sql_heavy_query_set_string (query, ":rowid", _tmp10_, &_inner_error_);
				_g_free0 (_tmp10_);
				if (_inner_error_ != NULL) {
					_g_object_unref0 (s);
					_g_object_unref0 (_s_it);
			...
			sql_heavy_query_set_string (query, ":file", _tmp11_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_string (query, ":title", _tmp12_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_string (query, ":artist", _tmp13_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_string (query, ":album", _tmp14_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_string (query, ":genre", _tmp15_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_string (query, ":comment", _tmp16_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":year", _tmp17_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":track", _tmp18_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":bitrate", _tmp19_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":length", _tmp20_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":samplerate", _tmp21_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":rating", _tmp22_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":playcount", _tmp23_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":skipcount", _tmp24_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":dateadded", _tmp25_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			sql_heavy_query_set_int (query, ":lastplayed", _tmp26_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				_g_object_unref0 (query);
			...
			_tmp27_ = sql_heavy_query_execute (query, NULL, &_inner_error_, NULL);
			_tmp28_ = _tmp27_;
...
void beat_box_data_base_manager_save_playlists (BeatBoxDataBaseManager* self, GeeCollection* playlists) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp2_;
	_tmp3_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "INSERT INTO `playlists` (`name`, `songs`, 'sort_column', 'sort_directi" \
...
":columns);", &_inner_error_);
	...
	self->priv->query = _tmp5_;
	{
		...
		while (TRUE) {
			...
			sql_heavy_query_set_string (self->priv->query, ":sort_column", _tmp12_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (p);
				_g_object_unref0 (_p_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp13_ = beat_box_tree_view_setup_sort_direction_to_string (p->tvs);
			_tmp14_ = _tmp13_;
			sql_heavy_query_set_string (self->priv->query, ":sort_direction", _tmp14_, &_inner_error_);
			_g_free0 (_tmp14_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (p);
				_g_object_unref0 (_p_it);
			...
			_tmp15_ = beat_box_tree_view_setup_columns_to_string (p->tvs);
			_tmp16_ = _tmp15_;
			sql_heavy_query_set_string (self->priv->query, ":columns", _tmp16_, &_inner_error_);
			_g_free0 (_tmp16_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (p);
				_g_object_unref0 (_p_it);
...
void beat_box_data_base_manager_update_playlist (BeatBoxDataBaseManager* self, BeatBoxPlaylist* p) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp2_;
	_tmp3_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "UPDATE `playlists` SET name=:name, songs=:songs, sort_column=:sort_col" \
...
"e", &_inner_error_);
	...
	_tmp7_ = beat_box_tree_view_setup_get_sort_column (p->tvs);
	sql_heavy_query_set_string (query, ":sort_column", _tmp7_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch16_sql_heavy_error;
	...
	_tmp8_ = beat_box_tree_view_setup_sort_direction_to_string (p->tvs);
	_tmp9_ = _tmp8_;
	sql_heavy_query_set_string (query, ":sort_direction", _tmp9_, &_inner_error_);
	_g_free0 (_tmp9_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp10_ = beat_box_tree_view_setup_columns_to_string (p->tvs);
	_tmp11_ = _tmp10_;
	sql_heavy_query_set_string (query, ":columns", _tmp11_, &_inner_error_);
	_g_free0 (_tmp11_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
...
void beat_box_data_base_manager_save_smart_playlists (BeatBoxDataBaseManager* self, GeeCollection* smarts) {
	...
	_g_object_unref0 (self->priv->transaction);
	self->priv->transaction = _tmp2_;
	_tmp3_ = sql_heavy_queryable_prepare ((SQLHeavyQueryable*) self->priv->transaction, "INSERT INTO `smart_playlists` (`name`, `and_or`, `queries`, 'limit', '" \
...
"ction, :columns);", &_inner_error_);
	...
	self->priv->item_count = _tmp6_;
	{
		...
		while (TRUE) {
			...
			_tmp16_ = beat_box_smart_playlist_get_limit (s);
			if (_tmp16_) {
				_tmp15_ = 1;
			} else {
				_tmp15_ = 0;
			}
			sql_heavy_query_set_int (self->priv->query, ":limit", _tmp15_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp17_ = beat_box_smart_playlist_get_limit_amount (s);
			sql_heavy_query_set_int (self->priv->query, ":limit_amount", _tmp17_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp18_ = beat_box_tree_view_setup_get_sort_column (s->tvs);
			sql_heavy_query_set_string (self->priv->query, ":sort_column", _tmp18_, &_inner_error_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
				if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			...
			_tmp19_ = beat_box_tree_view_setup_sort_direction_to_string (s->tvs);
			_tmp20_ = _tmp19_;
			sql_heavy_query_set_string (self->priv->query, ":sort_direction", _tmp20_, &_inner_error_);
			_g_free0 (_tmp20_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
			...
			_tmp21_ = beat_box_tree_view_setup_columns_to_string (s->tvs);
			_tmp22_ = _tmp21_;
			sql_heavy_query_set_string (self->priv->query, ":columns", _tmp22_, &_inner_error_);
			_g_free0 (_tmp22_);
			if (_inner_error_ != NULL) {
				_g_object_unref0 (s);
				_g_object_unref0 (_s_it);
...
"n, sort_direction=:sort_direction, columns=:columns WHERE name=:name", &_inner_error_);
	...
	_tmp9_ = beat_box_smart_playlist_get_limit (p);
	if (_tmp9_) {
		_tmp8_ = 1;
	} else {
		_tmp8_ = 0;
	}
	sql_heavy_query_set_int (query, ":limit", _tmp8_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch19_sql_heavy_error;
	...
	_tmp10_ = beat_box_smart_playlist_get_limit_amount (p);
	sql_heavy_query_set_int (query, ":limit_amount", _tmp10_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch19_sql_heavy_error;
	...
	_tmp11_ = beat_box_tree_view_setup_get_sort_column (p->tvs);
	sql_heavy_query_set_string (query, ":sort_column", _tmp11_, &_inner_error_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
			goto __catch19_sql_heavy_error;
	...
	_tmp12_ = beat_box_tree_view_setup_sort_direction_to_string (p->tvs);
	_tmp13_ = _tmp12_;
	sql_heavy_query_set_string (query, ":sort_direction", _tmp13_, &_inner_error_);
	_g_free0 (_tmp13_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
	...
	_tmp14_ = beat_box_tree_view_setup_columns_to_string (p->tvs);
	_tmp15_ = _tmp14_;
	sql_heavy_query_set_string (query, ":columns", _tmp15_, &_inner_error_);
	_g_free0 (_tmp15_);
	if (_inner_error_ != NULL) {
		_g_object_unref0 (query);
		if (_inner_error_->domain == SQL_HEAVY_ERROR) {
