...
public class Noise.Plugins.iPodLibrary : Noise.Library {
    ...
    public async void finish_initialization_thread() {
    ...
    public override void remove_medias(Gee.Collection<Media> toRemove, bool trash) {
        ...
        remove_medias_thread.begin (toRemove);
        
        return;
    }
    
    async void remove_medias_thread (Gee.Collection<Noise.Media> list) {
    ...
    public async void sync_medias_thread (Gee.Collection<Noise.Media> given_medias) {
    ...
    public async void sync_playlists_thread (Gee.Collection<Noise.Playlist> spls) {
