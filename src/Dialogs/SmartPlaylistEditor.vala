...
public class Noise.SmartPlaylistEditor : Window {
    ...
    public SmartPlaylistEditor(SmartPlaylist? sp = null, Library library) {
        ...
        add_button = new Gtk.Button.from_stock (Gtk.Stock.ADD); // FIXME
        ...
        save_button = new Gtk.Button.from_stock (Gtk.Stock.SAVE); // FIXME
        var close_button = new Gtk.Button.from_stock (Gtk.Stock.CANCEL); // FIXME
...
public class Noise.SmartPlaylistEditorQuery : GLib.Object {
    ...
    public SmartPlaylistEditorQuery (SmartQuery q) {
        ...
        remove_button = new Gtk.Button.from_stock (Gtk.Stock.REMOVE); // FIXME
