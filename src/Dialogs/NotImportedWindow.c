...
BeatBoxNotImportedWindow* beat_box_not_imported_window_construct (GType object_type, GeeLinkedList* files) {
	...
	_tmp21_ = (GtkCheckButton*) gtk_check_button_new_with_label ("Move all files to trash");
	...
	gtk_box_pack_start ((GtkBox*) listBox, (GtkWidget*) self->priv->trashAll, FALSE, TRUE, (guint) 5);
	gtk_box_pack_start ((GtkBox*) listBox, (GtkWidget*) self->priv->filesScroll, TRUE, TRUE, (guint) 5);
	_tmp48_ = (GtkHButtonBox*) gtk_hbutton_box_new ();
	bottomButtons = g_object_ref_sink (_tmp48_);
	...
	gtk_box_pack_start ((GtkBox*) self->priv->content, (GtkWidget*) listBox, TRUE, TRUE, (guint) 0);
