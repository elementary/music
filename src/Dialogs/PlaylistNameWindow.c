/* PlaylistNameWindow.c generated by valac 0.11.6, the Vala compiler
...
BeatBoxPlaylistNameWindow* beat_box_playlist_name_window_construct (GType object_type, BeatBoxPlaylist* original) {
	...
	nameLabel = g_object_ref_sink (_tmp6_);
	_tmp7_ = (GtkEntry*) gtk_entry_new ();
	_tmp8_ = g_object_ref_sink (_tmp7_);
	_g_object_unref0 (self->_name);
	self->_name = _tmp8_;
	_tmp9_ = (GtkButton*) gtk_button_new_with_label ("Done");
	...
	_tmp11_ = beat_box_playlist_get_name (original);
	gtk_entry_set_text (self->_name, _tmp11_);
	_tmp12_ = (GtkHButtonBox*) gtk_hbutton_box_new ();
	bottomButtons = g_object_ref_sink (_tmp12_);
	...
	_tmp13_ = beat_box_playlist_name_window_wrap_alignment ((GtkWidget*) nameLabel, 10, 0, 0, 0);
	_tmp14_ = _tmp13_;
	gtk_box_pack_start ((GtkBox*) self->priv->content, (GtkWidget*) _tmp14_, FALSE, TRUE, (guint) 0);
	_g_object_unref0 (_tmp14_);
	_tmp15_ = beat_box_playlist_name_window_wrap_alignment ((GtkWidget*) self->_name, 0, 10, 0, 10);
	_tmp16_ = _tmp15_;
	gtk_box_pack_start ((GtkBox*) self->priv->content, (GtkWidget*) _tmp16_, FALSE, TRUE, (guint) 0);
