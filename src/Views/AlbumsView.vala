...
public class Music.AlbumsView : Gtk.Paned, ViewInterface {
    ...
    construct {
        ...
        icon_view.selection_changed.connect (on_item_selected);
    ...
    private void on_item_selected () {
        ...
        var obj = icon_view.get_object_from_index (path.data.get_indices ()[0]);
        item_activated (obj);
    }

    private void on_item_activated (Gtk.TreePath? path) {
        popup_list_view.play_active_list ();
    }
