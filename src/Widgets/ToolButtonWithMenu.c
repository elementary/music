...
static void _lambda10_ (ToolButtonWithMenu* self);
static void __lambda10__gtk_menu_shell_deactivate (GtkMenuShell* _sender, gpointer self);
...
ToolButtonWithMenu* tool_button_with_menu_construct (GType object_type, GtkImage* image, const gchar* label, GtkMenu* _menu, GtkPositionType menu_orientation) {
	...
	g_signal_connect_object ((GtkMenuShell*) self->menu, "deactivate", (GCallback) __lambda10__gtk_menu_shell_deactivate, self, 0);
