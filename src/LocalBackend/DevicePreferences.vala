...
public class Music.DevicePreferences : GLib.Object {
    private string id;
    ...
    public Playlist? music_playlist {
        owned get {
            ...
            if ("p" in playlist_string) {
                ...
                return Music.libraries_manager.local_library.playlist_from_id (int64.parse (playlist_string));
            } else {
                playlist_string = playlist_string.replace ("s", "");
                return Music.libraries_manager.local_library.smart_playlist_from_id (int64.parse (playlist_string));
            }
        }
        set {
    ...
    public DevicePreferences (Music.Device device, Gda.Connection connection) {
